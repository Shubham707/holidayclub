                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Members List
                        <a class="btn btn-primary pull-right" href="<?php  //route('generate-pdf',['download'=>'pdf']) ?>">Download PDF</a>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                       <td><?= $i++;?></td>
                                        <td><a href="<?php echo e(url('/reportuser')); ?>/<?= $member->memberShipid;?>"><?= $member->memberShipid;?></a></td>
                                         <td><?= $member->m_name;?></td>
                                         <td><?= $member->c_name;?></td>
                                         <td><?= $member->city;?></td>
                                         <td><?= $member->doj;?></td>
